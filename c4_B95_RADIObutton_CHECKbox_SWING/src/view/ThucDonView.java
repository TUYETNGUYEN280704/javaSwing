...
public class ThucDonView extends JFrame {
	...
	public void init() {
		...
		jPanel_MonChinh.setBackground(Color.BLUE);
		jPanel_MonChinh.setLayout(new GridLayout(1,3));// sếp kiểu lưới nó bằng nhau 1 dòng 3 cột
	...
	//	list_buttonGroup_MonPhu = new ButtonGroup();
		...
		jPanel_luaChon.setLayout(new GridLayout(2,1)); // xsep lưới, 2 dòng 1 cột
